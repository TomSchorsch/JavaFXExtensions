...
--module-path C:\Users\...\JAVA_INSTALL\javafx-sdk-11.0.2\lib --add-modules=javafx.controls,javafx.fxml,javafx.web,javafx.graphics,javafx.media
  ...
  - Import the https://github.com/gillius/jfxutils project into Eclipse as a Java Project
    - <b><i>Every approach to import the jfxutils project using an Eclipse import wizards resulted in a badly messed up Maven project so I recommend the following instructions instead</b></i>
...
<b>To run the tests associated with the project:</b>
