...
public class TestMovingCallOuts implements FXTester {
	...
	public void execute(Logger logger) {
		...
		lineChart.setTitle("Test Moving CallOuts by Dragging The Line (need hand icon to be present to Drag)");
		...
		txt.addCenter("Test Moving CallOuts");
